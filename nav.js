...
<nav class="bg-black py-4 px-6 sticky top-0 z-[100] backdrop-blur-md bg-black/90 border-b border-neutral-900">
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-wrap items-center gap-6">
            <a href="index.html" class="text-white font-black italic tracking-tighter uppercase text-xl mr-6">
                ACADEMIC<span class="text-neutral-500">ATHLETE</span>
            </a>

            <div class="flex flex-wrap gap-6 md:gap-8 items-center font-mono text-[10px]">
                <a href="index.html" class="nav-link text-white border-b border-white pb-1">Lab Home</a>
                <a href="1rm-lab.html" class="nav-link text-neutral-500 hover:text-white">1RM</a>
                ...
                <a href="athlete-lab.html" class="nav-link text-purple-500 border-l border-neutral-800 pl-6 italic font-bold">
                    The Streak Lab
                </a>
            </div>
        </div>
