            ...
            <div class="flex gap-6 md:gap-8 items-center font-mono text-[10px]">
                ...
                <div class="relative" id="tools-wrapper">
                    <button id="tools-button"
                        class="text-neutral-500 hover:text-white flex items-center gap-1 uppercase font-bold tracking-widest py-2">
                        Tools
                        <svg id="tools-arrow" class="w-3 h-3 transition-transform"
                    ...
                    <div id="tools-menu-dropdown"
                        class="absolute left-0 top-full mt-2 w-72 hidden">
                        <div class="bg-[#111] border border-[#222] rounded-xl shadow-2xl p-4 grid gap-4">
