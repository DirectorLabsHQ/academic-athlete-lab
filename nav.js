            ...
            <div class="flex gap-6 md:gap-8 items-center font-mono text-[10px]">
                ...
                <div class="relative" id="tools-wrapper">
                    <button
                        id="tools-button"
                        type="button"
                        class="text-neutral-500 hover:text-white flex items-center gap-1 uppercase font-bold tracking-widest transition-colors duration-200 py-2"
                    >
                        Tools
                        <svg class="w-3 h-3 transition-transform duration-200" viewBox="0 0 20 20" fill="currentColor">
                ...
                <a href="athlete-lab.html" class="text-purple-500 border-l border-neutral-800 pl-6 italic font-bold uppercase tracking-widest">
                    The Streak Lab
                </a>
            </div>
        </div>
...
`;
    ...
    // Hover logic that actually works
