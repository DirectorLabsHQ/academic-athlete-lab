...
<nav id="main-nav" class="bg-black py-4 px-6 sticky top-0 border-b border-neutral-900 w-full" style="z-index: 999999;">
        ...
        <div class="flex items-center gap-8">
            ...
            <div class="flex gap-6 md:gap-8 items-center font-mono text-[10px]">
                ...
                <div class="relative" id="tools-wrapper">
                    <button id="tools-toggle" class="text-neutral-500 hover:text-white flex items-center gap-1 uppercase font-bold tracking-widest transition-colors duration-200 py-2">
                        Tools
                    ...
                    <div id="tools-menu" class="absolute left-0 top-full mt-2 w-72 bg-[#111] border border-[#222] rounded-xl shadow-2xl overflow-hidden hidden transition-all duration-200 z-50">
                        <div class="max-h-[70vh] overflow-y-auto no-scrollbar grid gap-4 p-4">
                            <div>
    ...
    if (toggle && menu && arrow && wrapper) {
        ...
        wrapper.addEventListener('click', (e) => e.stopPropagation()); // Prevent close when clicking inside
