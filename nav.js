...
<nav id="main-nav" class="bg-black py-4 px-6 sticky top-0 border-b border-neutral-900 w-full" style="z-index:999999;">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-8">
            <a href="index.html" class="text-white font-black italic tracking-tighter mr-4 uppercase text-xl">
                ACADEMIC<span class="text-neutral-500">ATHLETE</span>
            </a>

            <div class="flex gap-6 md:gap-8 items-center font-mono text-[10px]">
                <a href="index.html" class="text-white border-b border-white pb-1 uppercase font-bold tracking-widest">
                    Lab Home
                </a>
                ...
                <div class="relative" id="tools-wrapper">
                    <button id="tools-button"
                        class="text-neutral-500 hover:text-white flex items-center gap-1 uppercase font-bold tracking-widest py-2 bg-transparent border-none cursor-pointer">
                        Tools
                        <svg id="tools-arrow" class="w-3 h-3 transition-transform duration-200"
                            viewBox="0 0 20 20" fill="currentColor" style="pointer-events:none;">
                            <path d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"/>
                        </svg>
                    </button>

                    <div id="tools-menu-dropdown"
                        class="absolute left-0 top-full w-72 transition-all duration-150"
                        style="
                            opacity:0;
                            visibility:hidden;
                            pointer-events:none;
                            ...
                            z-index:1000000;
                        ">
                        <div class="bg-[#111] border border-[#222] rounded-xl shadow-2xl p-4 mt-2">
                ...
                <a href="recommendations.html" class="text-neutral-500 hover:text-white uppercase font-bold tracking-widest">
                    Gear & Recs
                </a>

                <a href="athlete-lab.html"
                   class="text-purple-500 border-l border-neutral-800 pl-6 italic font-bold uppercase tracking-widest">
                    The Streak Lab
                </a>
            </div>
        </div>
